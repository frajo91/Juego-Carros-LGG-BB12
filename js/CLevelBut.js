function CLevelBut(iXPos, iYPos, oSprite, bActive, iLevel, oParentContainer) {
  ...
  this.enable = function () {
    ...
    _bDisabled = false;
    if (_oLevel !== null) {
      _oLevelStroke.color = "#046543";
      _oLevel.color = "#046543";
    }
  };
  ...
  this.addScore = function (iScore) {
    var oScoreStroke = new createjs.Text(
      formatTime(iScore),
      " 30px " + PRIMARY_FONT,
      "#000000",
    );
  ...
  this.addLevelText = function (iLevel) {
    _oLevelStroke = new createjs.Text(
      iLevel,
      " 80px " + PRIMARY_FONT,
      "#000000",
    );
    ...
    _oLevelStroke.lineWidth = 50;
    _oLevelStroke.outline = 6;
