function CWorldMenu() {
  ...
  this._init = function () {
    ...
    var _oSprite = s_oSpriteLibrary.getSprite("juego");
    var _oJuego = createBitmap(_oSprite);
    _oJuego.regX = _oSprite.width / 2;
    _oJuego.regY = _oSprite.height / 2;
    _oJuego.x = CANVAS_WIDTH / 2;
    _oJuego.y = CANVAS_HEIGHT / 2 - _oSprite.height * 5;
    s_oStage.addChild(_oJuego);
    ...
    for (var i = 0; i < NUM_WORLDS; i++) {
      ...
      _aLevelButton[i].addEventListenerWithParams(
        ON_MOUSE_UP,
        this._onLevelBut,
        this,
        i,
    ...
    var oScore = new createjs.Text(
      " " + s_iTotalScore,
      "bold 30px " + PRIMARY_FONT,
      "#ffffff",
    );
  ...
  this._onLevelBut = function (iWorld) {
    ...
    aScore = [
      _aLevelScore[iStartIndex],
      _aLevelScore[iStartIndex + 1],
      _aLevelScore[iStartIndex + 2],
    ];
