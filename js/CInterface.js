function CInterface() {
  ...
  this._init = function () {
    ...
    _oCountdownText = new createjs.Text(
      "",
      " 300px " + PRIMARY_FONT,
      "rgba(255,224,0,1)",
    );
  ...
  this.refreshButtonPos = function (iNewX, iNewY) {
    ...
    if (s_bMobile) {
      ...
      _oButRight.setPosition(
        _pStartPosRight.x + iNewX,
        _pStartPosRight.y - iNewY,
      );
    }
  ...
  this.setLevelInfo = function (oFrameSprite, iLevel) {
    ...
    var iScale = 0.6;
    _oLevelButton = new CLevelBut(
      (oFrameSprite.width / 4) * iScale + oSprite.width + 12,
      (oFrameSprite.height / 2) * iScale,
      oFrameSprite,
      true,
      0,
      _oTimeContainer,
