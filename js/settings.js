...
var GAME_NAME = "JUEGO LGG+BB12";

//var PRIMARY_FONT = "ArialBold";
var PRIMARY_FONT = "Brandon";
...
SPRITES.BILLBOARDS = [
  SPRITES.BILLBOARD01.name,
  SPRITES.BILLBOARD02.name,
  SPRITES.BILLBOARD03.name,
  SPRITES.BILLBOARD04.name,
  SPRITES.BILLBOARD05.name,
];
SPRITES.PLANTS = [
  SPRITES.TREE1.name,
  SPRITES.TREE2.name,
  SPRITES.DEAD_TREE.name,
  SPRITES.PALM_TREE.name,
  SPRITES.BUSH1.name,
  SPRITES.BUSH2.name,
  SPRITES.CACTUS1.name,
  SPRITES.STUMP.name,
  SPRITES.BOULDER.name,
];
SPRITES.CARS = [
  SPRITES.CAR01.name,
  SPRITES.CAR02.name,
